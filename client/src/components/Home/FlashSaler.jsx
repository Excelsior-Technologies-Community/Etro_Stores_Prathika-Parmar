...
>
    {/* FIX: Used 'gap-2' for spacing instead of 'mb-*' classes to prevent text from overflowing */}
    ...
    {/* FIX: Changed negative absolute positioning to positive (right-6 bottom-4) so it stays inside */}
    <img 
...
const FlashSaler = () => {
    ...
    // THE 4 BLOCKS CONTAINING 8 PRODUCTS TOTAL
    // THE 4 BLOCKS CONTAINING 8 PRODUCTS TOTAL
const flashSalesData = [
    ...
    },
    {
        ...
        products: [
            // FIX: Added targetDate to these products!
            ...
            <div className="max-w-[1440px] mx-auto w-full box-border" style={{ paddingTop: '40px', paddingLeft: '40px', paddingRight: '40px' }}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {flashSalesData.map((block) => (
                        <FlashSaleBlock key={block.id} block={block} />
                    ))}
                </div>
